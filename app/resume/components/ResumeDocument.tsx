  ...
  return (
    <header className="border-b-2 border-slate-900 pb-3 mb-4">
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-1 items-center text-[8pt] font-medium text-slate-600">
        ...
        <a href="https://leetcode.com/u/AbhishekShekhawat/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-slate-900 transition-colors">
          <svg className="w-3 h-3 shrink-0 text-slate-500" fill="currentColor" viewBox="0 0 24 24">
          ...
          leetcode.com/u/AbhishekShekhawat
        </a>
        ...
        {visibleProjects.map((project) => (
          <div key={project.title}>
            <div className="flex justify-between items-start gap-2">
              ...
              {/* Show live link and/or github — only when they exist */}
              <div className="flex items-center gap-2 shrink-0 flex-wrap justify-end">
                {project.link && (
                  <a
                    ...
                    className="text-[7.5pt] font-bold text-blue-700 hover:text-blue-900 transition-colors"
                  >
                ...
                {project.github && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[7.5pt] font-semibold text-slate-500 hover:text-slate-700 transition-colors"
                  >
                    {project.link ? "GitHub" : project.github.replace("https://github.com/", "github.com/")}
                  </a>
                )}
              </div>
            </div>
