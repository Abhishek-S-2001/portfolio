...
export default function Contact() {
  const contactMethods = [
    {
      title: "Email",
      value: "abhishek.shekhawat.1920@gmail.com",
      link: "mailto:abhishek.shekhawat.1920@gmail.com",
      icon: (
    ...
    {
      title: "LinkedIn",
      value: "linkedin.com/in/abhishek-shekhawat",
      link: "https://linkedin.com/in/abhishek-shekhawat",
      icon: (
    ...
    {
      title: "GitHub",
      value: "github.com/Abhishek-S-2001",
      link: "https://github.com/Abhishek-S-2001",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
