...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-50 bg-white/80 backdrop-blur-md border border-blue-300 shadow-lg shadow-blue-100/50 rounded-2xl transition-all print:hidden">
